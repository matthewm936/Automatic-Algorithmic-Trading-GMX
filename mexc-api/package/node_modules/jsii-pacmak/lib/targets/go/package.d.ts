...
export declare abstract class Package {
    ...
    private readonly submoduleSpec;
    ...
    constructor(typeSpec: readonly Type[], submoduleSpec: readonly JsiiSubmodule[], packageName: string, filePath: string, moduleName: string, version: string, root?: Package);
